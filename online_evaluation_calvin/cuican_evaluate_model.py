...
class DiffusionModel(CalvinBaseModel):
    ...
    def step(self, obs, instruction):
        ...
        pcds = np.stack([
            obs["pcd_obs"]["pcd_static"], obs["pcd_obs"]["pcd_gripper"] # depth_obs
        ], axis=0).transpose(0, 3, 1, 2) # [ncam, 3, H, W]
