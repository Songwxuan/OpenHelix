...
training_checkpoint=/zhaohan/Wenxuan/3d_diffuser_actor/train_logs/diffuser_actor_calvin.pth
#当使用这个checkpoint时，起始train_iters就是65000，要在这个基础上加
run_log_dir=testdiffusion_taskABC_D-C$C-B$B-lr$lr-DI$dense_interpolation-$interpolation_length-H$num_history-DT$diffusion_timesteps-backbone$backbone-S$image_size-R$relative_action-wd$wd
